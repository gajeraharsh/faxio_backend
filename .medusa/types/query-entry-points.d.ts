...
export type WishlistItem = {
  ...
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
  product_link: Maybe<Array<Maybe<LinkProductProductWishlistWishlistItem>>>;
...
export type Banner = {
  ...
  id: Scalars['ID']['output'];
  name: Scalars['String']['output'];
  desktop_image_url: Maybe<Scalars['String']['output']>;
  mobile_image_url: Maybe<Scalars['String']['output']>;
...
export type Blog = {
  ...
  content: Scalars['String']['output'];
  hashtags: Maybe<Scalars['JSON']['output']>;
...
export type ReelUploaderTypeEnum =
  | 'admin'
  | 'user';

export type ReelTypeEnum =
  | 'video'
  | 'image';
...
export type Reel = {
  ...
  blog_id: Maybe<Scalars['String']['output']>;
  uploader_type: ReelUploaderTypeEnum;
  uploader_id: Maybe<Scalars['String']['output']>;
  type: ReelTypeEnum;
  name: Scalars['String']['output'];
  hashtags: Maybe<Scalars['JSON']['output']>;
  is_display_home: Scalars['Boolean']['output'];
...
export type CustomerEmailVerification = {
  __typename?: 'CustomerEmailVerification';
  id: Scalars['ID']['output'];
  customer_id: Maybe<Scalars['String']['output']>;
  email: Scalars['String']['output'];
  code: Scalars['String']['output'];
  expires_at: Scalars['DateTime']['output'];
  consumed_at: Maybe<Scalars['DateTime']['output']>;
...
export type CustomerPasswordResetToken = {
  __typename?: 'CustomerPasswordResetToken';
  id: Scalars['ID']['output'];
  customer_id: Maybe<Scalars['String']['output']>;
  email: Scalars['String']['output'];
...
export type Product = {
  ...
  wishlist_item_link: Maybe<LinkProductProductWishlistWishlistItem>;
...
export type LinkProductProductWishlistWishlistItem = {
  __typename?: 'LinkProductProductWishlistWishlistItem';
  product_id: Scalars['String']['output'];
...
declare module '@medusajs/framework/types' {
  interface RemoteQueryEntryPoints {
    ...
    customer_email_verifications: CustomerEmailVerification
    customer_password_reset_token: CustomerPasswordResetToken
    customer_password_reset_tokens: CustomerPasswordResetToken
    ...
    product_wishlist_item: LinkProductProductWishlistWishlistItem
  }
}